    ...
    <div class="footer-content">
        ...
        <div class="footer-section links">
            ...
            <div>
                ...
                <div><a href="/api/aboutus.php">Quiénes somos</a></div>
                <div><a href="/api/contact.php">Dónde estamos</a></div>
                <div><a href="/api/shop.php">Tienda</a></div>
            </div>
        </div>
    </div>
    <div class="footer-bottom">
        &copy; 2024 Ferretería Vegagrande | Todos los derechos reservados
    </div>
</footer>
</body>
</html>