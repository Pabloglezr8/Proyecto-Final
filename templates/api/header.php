    ...
    <header class="index-header">
        <div class="header-top-container">
            <div class="identity-container">
                <div class="Logo-container">
                    <a href="/index.php">
                        ...
                        <img id="logo-completo" src="/assets/img/LogoCompleto.png" alt="Logo">
                    </a>
                </div>
            ...
            <nav class="user-menu hidden">
                <div class="menu-element cart-icon">
                    <a href="/templates/my_cart.php"><span id="cart-count"><?php echo $total_productos; ?></span><img src="/assets/img/icons/shopcart.png" alt="shopcart"></a>
                </div>
                <?php if($isLoggedIn): ?>
                    <div class="menu-element">
                        <a class="my-account" href="/templates/user.php">
                            <img src="/assets/img/icons/myaccount.png" alt="">
                            <span class="user-name"><?php echo $_SESSION['name'];?></span>
                        </a>
                    </div>                    <div class="menu-element"><a href="/api/logout-process.php">LogOut</a></div>
                <?php else: ?>
                    <div class="menu-element"><a href="/templates/login.php">LogIn</a></div>
                <?php endif; ?>
                <?php if(!$isLoggedIn): ?>
                    <div class="menu-element"><a href="/templates/register.php">Register</a></div>
                <?php endif; ?>
            </nav>
        </div>
        ...
        <div class="menu-container navigation-menu-container hidden">
            <nav class="navigation-menu">
                <div class="menu-element"><a href="/templates/aboutus.php">Quiénes somos</a></div>
                <div class="menu-element"><a href="/templates/contact.php">Dónde estamos</a></div>
                <div class="menu-element"><a href="/templates/shop.php">Tienda</a></div>
                <?php if (isset($_SESSION['role']) && $_SESSION['role'] == 0): ?>
                    <div class="menu-element"><a href="/templates/admin.php">Panel de Administrador</a></div>
                <?php endif; ?>
            </nav>
    ...
    <div class="hamburger-container">
        <nav class="burger-menu">
            <div class=" user-menu-burger">
                <div class="menu-element cart-icon">
                    <a href="/templates/my_cart.php"><span id="cart-count-burger"><?php echo $total_productos; ?></span><img src="/assets/img/icons/shopcart.png" alt="shopcart"></a>
                </div>
                <?php if($isLoggedIn): ?>
                    <div class="menu-element">
                        <a class="my-account" href="/templates/user.php">
                            <img src="/assets/img/icons/myaccountOrange.png" alt="">
                            <span class="user-name"><?php echo $_SESSION['name'];?></span>
                        </a>
                    </div>
                <div class="menu-element"><a href="/api/logout-process.php"><img class="logout" src="/assets/img/icons/logout.png" alt=""></a></div>
                <?php else: ?>
                <div class="menu-element"><a href="/templates/login.php">LogIn</a></div>
                <?php endif; ?>
                <?php if(!$isLoggedIn): ?>
